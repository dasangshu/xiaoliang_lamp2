...
def create_config():
    ...
    config = {
        ...
        "model_name": "coco_pose_yolo11n_pose_256_p4"
    }
    
    with open('pose_256_p4_config.json', 'w') as f:
...
def main():
    ...
    # 检查输入ONNX文件是否存在
    input_model = 'yolo11n-pose-256.onnx'
    ...
    try:
        ...
        # 导出量化后的ONNX模型
        quantized_onnx = f'coco_pose_yolo11n_pose_256_p4_int8.onnx'
        ...
        # 导出ESPDL模型
        espdl_model = f'coco_pose_yolo11n_pose_256_p4.espdl'
        espdl_config = f'coco_pose_yolo11n_pose_256_p4.json'
        ...
        print('256x256 P4 ESPDL conversion completed successfully!')
        ...
        # 备选方案：直接加载ONNX并转换
        try:
            graph = BaseGraph(name='coco_pose_yolo11n_pose_256_p4', built_from=model)
            ...
            print('256x256 P4 ESPDL conversion completed successfully (alternative method)!')
