...
def create_config():
    ...
    with open('pose_224_p4_final_config.json', 'w') as f:
...
def main():
    ...
    ONNX_PATH = 'yolo11n-pose-224.onnx'
    ESPDL_PATH = 'coco_pose_yolo11n_pose_224_p4_final.espdl'
    ...
    dataset = CaliDataset('calib_yolo11n-pose', img_shape=224)
    ...
    # 执行量化
    print(f'Quantizing 224x224 model to {PLATFORM}...')
    try:
        ...
        export_ppq_graph(
            graph=quantized,
            platform=PLATFORM,
            graph_save_to='coco_pose_yolo11n_pose_224_p4_final_int8.onnx',
            config_save_to='coco_pose_yolo11n_pose_224_p4_final.json',
            save_as_espdl=True)

        print('224x224 P4 quantization completed successfully!')
