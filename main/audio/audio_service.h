...
public:
    ...
    bool IsIdle();
    bool IsOutputActiveOrRecentlyActive(uint32_t recent_ms);
    ...
    void RunLocalAudioFileTask(const char* path, uint32_t generation);
...
private:
    ...
    std::atomic<uint32_t> local_playback_generation_{0};
